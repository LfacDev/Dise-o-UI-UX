...
router.get('/buscar_actividades', async(req, res)=>{
        try{
            const [result] = await pool.query('call ListarTodasLasActividades()');
...
router.get('/ver_actividad/:IDActividad', async(req, res)=>{
    ...
    d.FK_ActividadTuristica, d.Disponible, 
	a.ID_ActividadTuristica, a.Nombre_Actividad, a.Descripcion_Actividad, a.Precio_Actividad, a.Descripcion_Mini, a.EsFavorito,
    f.año, f.mes, f.dia, f.hora,
    ...
    GROUP BY 
    d.FK_ActividadTuristica, d.Disponible,
    a.ID_ActividadTuristica, a.Nombre_Actividad, a.Descripcion_Actividad, a.Precio_Actividad, a.EsFavorito,
    t.Nombre_TipoActividadTur, 
    p.Nombre_Pais, 
    i.URL_ImagenActividad, 
    c.Nombre_Ciudad, 
